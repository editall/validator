...
class c extends m {
  ...
  check(t, i) {
    let o, r = "";
    const h = this.#s.some((p) => (o = t, p.ruleList.every(([N, d]) => (o = N(o, i), o === c.FALSE ? (r = d + "", !1) : !0))));
    return new a(
      h,
      o,
